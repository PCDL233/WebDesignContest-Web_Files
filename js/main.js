...
var classCallCheck = function (t, e) {
    ...
    , VanillaTilt = function () {
        ...
        return t.prototype.isSettingTrue = function (t) {
            return "" === t || !0 === t || 1 === t
        }
            ,
            ...
            ,
            t.prototype.onWindowResizeBind = function () {
...
"undefined" != typeof document && (window.VanillaTilt = VanillaTilt,
...
const ease = {
    ...
    exponentialInOut: t => 0 == t || 1 == t ? t : t < .5 ? .5 * Math.pow(2, 20 * t - 10) : -.5 * Math.pow(2, 10 - 20 * t) + 1,
    sineOut: t => {
